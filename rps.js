...
const closeRules = () => {
  ...
  const start = (userChoice) => {
    ...
    if (userChoice === "rock") {
      ...
      document.getElementById("userChoosed").src = "./images/rock.png";
    } else if (userChoice === "paper") {
      document.getElementById("iClicked").style.border = "20px solid #ffa943";
      document.getElementById("userChoosed").src = "images/paper.png";
    } else if (userChoice === "scissor") {
      document.getElementById("iClicked").style.border = "20px solid #bd00ff";
      document.getElementById("userChoosed").src = "./images/scissors.png";
    }
  ...
  const play = (userChoice) => {
    ...
    if (computerChoice === "rock") {
      ...
      document.getElementById("loadingDone").src = "./images/rock.png";
      ...
      document.getElementById("loadingDone").src = "./images/scissors.png";
    }
